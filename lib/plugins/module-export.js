  ...
  compiler.plugin('compilation', function(compilation) {
    compilation.plugin('optimize-tree', function(chunks, modules, callback) {
      Async.each(modules, function(module, callback) {
          resolvePackage(compiler.inputFileSystem, packagePaths, contextPaths, module, callback);
        },
        function(err) {
...
function resolvePackage(inputFileSystem, packagePaths, componentPaths, module, callback) {
  var components = module.resource.split(/\//g),
      i = components.length,
      packagePath;
  Async.whilst(
