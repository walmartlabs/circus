          ...
          module.dependencies.forEach(function(dependency) {
            if (dependency instanceof CssDependency && dependency.text) {
              ...
              _.each(dependency.children, function(child) {
                ...
                src = src.replace(/__webpack_require__.p\b/g, '""');
  ...
  this.compilation.addModuleDependencies(dependency.module, [[loader]], this.compilation.bail, null, true, function rebuild(err) {
    ...
    if (!err && loader.module) {
      ...
      if (!loader.module.error) {
        ...
        var children = _.map(source.modules, function(child) {
    ...
    if (children.length) {
      compilation.addModuleDependencies(dependency.module, children, compilation.bail, null, true, function(err) {
        dependency.children = _.map(children, function(child) {
          return child;
        });
        callback(err);
      });
